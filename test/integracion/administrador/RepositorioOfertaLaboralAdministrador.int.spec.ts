...
import { OfertaLaboralNoExiste } from '../../../src/administrador/aplicacion/excepciones/oferta/OfertaLaboralNoExiste'
import { OfertaLaboralYaExiste } from '../../../src/administrador/aplicacion/excepciones/oferta/OfertaLaboralYaExiste'
...
const empresa_prueba = {
  ...
  codigoPostal: '1010',
  direccionCalle: 'Avenida testing Administrador',
  correoElectronico: 'testingAdministrador@testing.com',
  nombre: 'Testing Administrative Inc.',
}

describe('Repositorio de persistencia Administrador: Ofertas Laborales', () => {
