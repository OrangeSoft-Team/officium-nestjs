...
import { VerDetallesOfertaLaboralAdministrador } from '../../../src/administrador/aplicacion/servicios/VerDetallesOfertaLaboralAdministrador';
...
describe('administrador: Ver Detalles de Oferta laboral suministrada', () => {
  let mockRepositorioOfertaLaboral: RepositorioOfertaLaboral
  let casoUso: VerDetallesOfertaLaboralAdministrador
  ...
  beforeEach(() => {
    ...
    casoUso = new VerDetallesOfertaLaboralAdministrador(
      mockRepositorioOfertaLaboral,
    )
  })

  it('Debe obtener una oferta laboral con sus datos para una empresa valida', () => {
    const resultado = casoUso.ejecutar({idOferta: '7453dc15-7ff2-4c37-9455-de661a5275b1'})
