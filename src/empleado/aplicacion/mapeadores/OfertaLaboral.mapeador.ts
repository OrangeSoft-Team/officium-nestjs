...
import { ConsultarOfertaLaboralPersistenciaDTO, VerDetallesOfertaLaboralPersistenciaDTO } from "../puertos/IRepositorioOfertaLaboral";
...
import { DominioDetallesOfertaLaboralDTO, VerDetallesOfertaLaboralDTO } from "../dto/VerDetallesOfertaLaboral.dto";
...
export class OfertaLaboralMapeador {
    ...
    public static MapConsultaDominioOferta(oferta: ConsultarOfertaLaboralPersistenciaDTO,): DatosOfertaLaboral &{nombreEmpresa: NombreEmpresa} {
    ...
    public static MapDetalleDominioOferta(oferta: VerDetallesOfertaLaboralPersistenciaDTO,): DatosOfertaLaboral & DominioDetallesOfertaLaboralDTO {
      //Mapea la respuesta al dominio para validar los valores 
      return  {
          identificador: Identificador.crear(oferta.id),
          titulo: TituloOferta.crear(oferta.titulo),
          ...
          codigoPostalEmpresa: CodigoPostalDireccion.crear(oferta.codigoPostalEmpresa),
    ...
    public static MapDetalleRespuestaOferta(
      oferta: DatosOfertaLaboral & DominioDetallesOfertaLaboralDTO,
        ...
        return {
          ...
          fecha: oferta.fechaPublicacion.obtenerFecha(),
    ...
    private static obtenerDireccion (direccion: DominioDetallesOfertaLaboralDTO){
        return direccion.calleEmpresa.obtenerCalle +', '+
