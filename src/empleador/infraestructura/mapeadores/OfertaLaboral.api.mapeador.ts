...
export class OfertaLaboralAPIMapeador {
  ...
  // Mapear solicitud http para ver datos basicos de ofertas laborales activas al
  // DTO de capa de aplicacion respectivo
  ...
  // Mapear respuesta de capa de aplicación de datos basicos de ofertas laborales
  // activas al DTO de capa de infraestructura
