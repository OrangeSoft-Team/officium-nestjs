...
import {
  IntentosPermitidosCuestionarioVacio,
  LongitudInvalidaIntentosPermitidosCuestionario,
} from '../../excepciones/cuestionario/IntentosPermitidosCuestionario.excepciones'
