...
export class DuracionEstimadaCuestionario implements IValueObject {
    ...
    public static crear(duracionEstimadaEscala: ESCALA_VALORES, duracionEstimadaValor: number,): DuracionEstimadaCuestionario {
      // No debe ser vacio
      ...
      // Si no hay errores
      return new DuracionEstimadaCuestionario(duracionEstimadaEscala, duracionEstimadaValor)
    }
  }