...
import { TituloCursoVacio, LongitudInvalidaTituloCurso } from '../../excepciones/curso/TituloCurso.excepciones'
...
export class TituloCurso implements IValueObject {
    ...
    public static crear(titulo: string): TituloCurso {
      ...
      if (titulo == null || titulo == undefined || titulo == '')
        throw new TituloCursoVacio(
          'El titulo del curso no puede estar vacio.',
        )
      if (titulo.length < 4)
